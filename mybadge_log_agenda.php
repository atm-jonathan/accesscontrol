...
/**
 *  \file       mybadge_log_agenda.php
 *  \ingroup    accesscontrol
 *  \brief      Tab of events on Mybadge_log
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Mybadge_log")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Mybadge_log"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_mybadge_log_'.$object->id;
