...
/**
 *  \file       mybadge_note.php
 *  \ingroup    sigrebadge
 *  \brief      Tab for notes on MyBadge
 */
...
$title = $langs->trans('MyBadge').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("MyBadge"), -1, $object->picto);
