...
require_once __DIR__.'/class/mybadge.class.php';
...
$title = $langs->trans("MyBadges");
//$help_url = "EN:Module_MyBadge|FR:Module_MyBadge_FR|ES:Módulo_MyBadge";
$help_url = '';
$morejs = array();
$morecss = array();
...
$topicmail = "SendMyBadgeRef";
$modelmail = "mybadge";
$objecttmp = new MyBadge($db);
