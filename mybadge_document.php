...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->sigrebadge->multidir_output[$object->entity ? $object->entity : $conf->entity]."/mybadge/".get_exdir(0, 0, 0, 1, $object);
}
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd  = $user->hasRight('sigrebadge', 'mybadge', 'write'); // Used by the include of actions_addupdatedelete.inc.php and actions_linkedfiles.inc.php
} else {
	$permissiontoread = 1;
	$permissiontoadd  = 1;
}
