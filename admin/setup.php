...
dol_include_once('/accesscontrol/core/modules/accesscontrol/doc/pdf_standard_mybadge.modules.php');
...
if (!getDolGlobalString('ACCESSCONTROL_ADDON_NUMBER')) {
	$conf->global->ACCESSCONTROL_ADDON_NUMBER = 'mod_accesscontrol_standard';
}
...
$item = $formSetup->newItem('ACCESSCONTROL_PREFIX');
$item->defaultFieldValue = 'BDG';
/*
...
if ($action == 'updateMask') {
	...
	$tmpobjectkey = GETPOST('MyBadge');
	
	$tmpobject = new MyBadge($db);
...
print dol_get_fiche_head($head, 'settings', $langs->trans($page_name), -1, "accesscontrol@accesscontrol");

// Setup page goes here
echo '<span class="opacitymedium">'.$langs->trans("AccessControlSetupPage").'</span><br><br>';
...
$myTmpObjects['mybadge'] = array('label'=>'MyBadge', 'includerefgeneration'=>1, 'includedocgeneration'=>1, 'class'=>'MyBadge');
