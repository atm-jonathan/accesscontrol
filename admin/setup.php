...
dol_include_once('/sigrebadge/core/modules/sigrebadge/doc/pdf_standard_mybadge.modules.php');
...
if (!getDolGlobalString('SIGREBADGE_ADDON_NUMBER')) {
	$conf->global->SIGREBADGE_ADDON_NUMBER = 'mod_sigrebadge_standard';
}
...
$item = $formSetup->newItem('SIGREBADGE_PREFIX');
...
print dol_get_fiche_head($head, 'settings', $langs->trans($page_name), -1, "sigrebadge@sigrebadge");

// Setup page goes here
echo '<span class="opacitymedium">'.$langs->trans("SigreBadgeSetupPage").'</span><br><br>';
