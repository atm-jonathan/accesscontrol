...
/**
 *      \file       admin/mybadge_log_extrafields.php
 *		\ingroup    accesscontrol
 *		\brief      Page to setup extra fields of mybadge_log
 */
...
$elementtype = 'accesscontrol_mybadge_log'; //Must be the $table_element of the class that manage extrafield
...
$textobject = $langs->transnoentitiesnoconv("Mybadge_log");
...
print dol_get_fiche_head($head, 'mybadge_log_extrafields', $langs->trans($page_name), -1, 'accesscontrol@accesscontrol');
