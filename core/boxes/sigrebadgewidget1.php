...
/**
 * \file    sigrebadge/core/boxes/sigrebadgewidget1.php
 * \ingroup sigrebadge
 * \brief   Widget provided by SigreBadge
 *
 ...
 */
class sigrebadgewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "sigrebadgebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "sigrebadge@sigrebadge";
	 ...
	 */
	public $depends = array('sigrebadge');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "sigrebadge@sigrebadge"));
		...
		// $this->hidden = !$user->hasRight('sigrebadge', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/sigrebadge/class/sigrebadge.class.php");

		// Populate the head at runtime
		$text = $langs->trans("SigreBadgeBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_sigrebadge@sigrebadge',
